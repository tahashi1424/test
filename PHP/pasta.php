...
<body>
	...
	<div class="review">
	<div class="juice-box">
		<img src="https://cdn.pixabay.com/photo/2015/04/08/13/13/pasta-712664_1280.jpg" width="70%" class="items-image">
	
	<div class="juice-menu">
		<p class="menu-name">PASTA</p>
		<div class="icon-pepper">
            <img src="https://cdn.pixabay.com/photo/2020/08/25/18/39/pepper-5517792_1280.png" width="20px">
        </div>
		<p><strong>￥1296（税込）</strong></p>
	</div>
</div>
<div class="list">
<div class="review-title">
	<img src="https://cdn.pixabay.com/photo/2017/10/25/18/10/peer-review-icon-2888794_1280.png" width="50px" style="padding-right: 20px;">
	<h4>レビュー一覧</h4>
</div>
	<div class="review-coment">
		<div class="review-item">
		<div class="review-acoount">
		<img src="http://flat-icon-design.com/f/f_object_116/s512_f_object_116_0bg.png" width="40px">
		<p>tanaka</p>
	</div>
</div>
		<p class="orange">ソースが絶品です。また食べたい。</p>
	</div>
	<br>
	<div class="review-coment">
		<div class="review-item">
		<div class="review-acoount">
		<img src="http://flat-icon-design.com/f/f_object_115/s512_f_object_115_0bg.png" width="40px">
		<p>sato</p>
	</div>
</div>

		<p class="orange">具材にこだわりを感じました。</p>
	</div>
	</div>
</div>
<div class="back">
<a href="index10.php#menu">← メニューに戻る</a>
</div>
</body>
</html>